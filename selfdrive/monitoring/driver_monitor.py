...
_AWARENESS_PRE_TIME_TILL_TERMINAL = 150.  # a first alert is issued 25s before expiration
...
_HI_STD_TIMEOUT = 5000
_HI_STD_FALLBACK_TIME = 10000  # fall back to wheel touch if model is uncertain for a long time
